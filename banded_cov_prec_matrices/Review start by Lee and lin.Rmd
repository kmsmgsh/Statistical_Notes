...
I start with the [@An:2014jc] which is the frequecy part of the banded-width test, then another approach is done by [@Cheng:2017jh]. 

Both three papers are using Cholesky factor to model the precision matrices. 

---

Then the @Lee:2018vj use a similar method by @An:2014jc, however he used Bayesian approach rather than the frequency methods. 
...
#断点记录：到构造test statistics：然后呢，是把test写出来然后继续往后看。
